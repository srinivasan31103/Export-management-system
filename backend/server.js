...
const allowedOrigins = [
  ...
  'https://exportmanagementsystem.vercel.app',
  'https://export-management-system.vercel.app'
].filter(Boolean);

app.use(cors({
  origin: function(origin, callback) { if (!origin) return callback(null, true); callback(null, true); },
  credentials: true
}));
